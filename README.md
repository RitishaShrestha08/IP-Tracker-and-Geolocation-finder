...
## This tool helps to track IP address and find Geolocation of the given IP address.
## Technology used
- Python
- Libraries Used:
  socket
...
- Display te open/closed ports
- Shows country, city, region, ISP, latitude and longitude.
## How to Run
1. Install python3
2. Install requests library
3. Copy the code below : scanner.py
4. Run the program : python scanner.py
